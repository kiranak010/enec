      ...
      <div className="gradient-navy flex flex-1 flex-col px-6 py-12 sm:px-12">
        ...
        <div className="flex flex-1 items-center justify-center">
          <div className="w-full max-w-md">
            ...
            >
              <div>
                <label htmlFor="login-email" className="mb-1.5 block text-sm font-semibold text-navy-900">
                  Email address
                </label>
                <input
                  id="login-email"
              ...
              <div className="mt-5">
                <label htmlFor="login-password" className="mb-1.5 block text-sm font-semibold text-navy-900">
                  Password
                </label>
                <input
                  id="login-password"
